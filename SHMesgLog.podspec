...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => "https://github.com/songoku20/SHMesgLog/releases/download/0.2.3/SHMesgLog-0.2.3.zip" }
  ...
  s.public_header_files = 'SHMesgLog.framework/Headers/SHMesgLog.h'
  s.source_files        = 'SHMesgLog.framework/Headers/SHMesgLog.h'
